...
- [Тема 12](./Sem.%2012): Колекции от обекти в полиморфна йерархия. Копиране, триене, разпознаване и прихващане. Шаблони. Умни указатели.
...
- [Тема 15](./Sem.%2015): Type casting. SOLID принципи. Въведение в Design Patterns.
