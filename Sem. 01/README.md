...
❗ Свалете "Struct Layout" extension-a на Visual studio, за да можете да видите визуализация на това как са подредени член-данните на вашите структура с тяхното подравняване в паметта.
