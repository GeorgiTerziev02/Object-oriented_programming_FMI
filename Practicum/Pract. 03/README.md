...
## Задача 1:
Да се напише програма, която прочита две матрици, умножава ги и записва резултата в нов отделен файл. Матриците се съхраняват в отделни файлове в следния формат:
