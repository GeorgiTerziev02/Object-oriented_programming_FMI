...
В даден момент ще достигнем до следната ситуация било то с фигури или друга йерархия.

Имаме следната йерархия:
...
Да нарушим абстракцията и директно да разберем към какво сочи всеки Shape* с 3 if проверки и dynamic_cast. Сами можем да предположим, че това не е правилното решение.
