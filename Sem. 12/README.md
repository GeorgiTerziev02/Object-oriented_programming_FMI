...
Директно да разберем към какво сочи всеки Shape* с 3 if проверки и dynamic_cast или като добавим във всеки наследник getType функция, която връща стойност от enum. Сами можем да предположим, че това не е правилното решение.
