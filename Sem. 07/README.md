...
## [Oператори](https://en.cppreference.com/w/cpp/language/operators){:target="_blank"}
### Видове оператори.
...
Приоритета и асоциативността на операторите може да проверите [тук](https://en.cppreference.com/w/cpp/language/operator_precedence)
